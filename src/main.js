module.exports.loop = function () {
    const creepSettings = require('./config_creepSettings');
    ...
    creepSettings.forEach((creepSetting) => {
        var currentCreepCount = currentCreepCounts.find(
            (c) => c.role == creepSetting.role
        ).count;
        if (currentCreepCount < creepSetting.count) {
            ...
            Game.spawns['Spawn1'].spawnCreep(
                creepSetting.generations[0].body,
                newName,
